// Anotações de aula
// Práticas de leitura de código
// Passo 1:
// Não partir do detalhe, iniciar lendo o nome das classes, interfaces, enums com a finalidade e entender as responsabilidades (o que - não como)
// Passo 2:
// Um panorama geral de responsabilidades.
// Passo 3:
// Antes de entrar no funcionamento das classes, executar o código main para entender o uso das classes expostas (entender isso) 
// Passo 4:
// Separação de contexto de tarefa
// Em equipes reais precisamos entender que enquanto um profissional A faz a interface, o profissional B já faz o código parcial da soluçã. Por fim pode existir um profsissional C que faça a integração das partes.
// Passo 5:
// Do fácil ao díficil, comece a explorar as classes que são mais fáceis e menores, de prefêrencia para as mais fáceis. Existem classes curtas, com pouco código, que são complexas. Então use a técnica: As fáceis E menores primeiro.
// Passo 6:
// Nunca se assuste entender um código é um exercício de desconforto não se preocupe. Siga em frente.
